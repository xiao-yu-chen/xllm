...
```bash
export MODELSCOPE_CACHE=path-to-model # 默认 ~/.cache/modelscope/hub
...
## 启动命令 - Kimi_k25（双机 16卡32die tp=4, dp=8, ep=32）
...
ranktable配置指导：[https://www.hiascend.com/document/detail/zh/canncommercial/83RC1/hccl/hcclug/hcclug_000014.html](https://www.hiascend.com/document/detail/zh/canncommercial/83RC1/hccl/hcclug/hcclug_000014.html)
...
日志出现"Application startup complete."表示服务成功拉起。
